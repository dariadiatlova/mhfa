...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.eval == True:
        scorefile_score = open(
            args.result_save_path + "/Eval_scores_mean_O_All.txt", "w"
        )
        ...
        for i in range(1, 5):
            ...
            if args.gpu == 0:
                ...
                mindcf_1, threshold_1 = ComputeMinDcf(
                    fnrs, fprs, thresholds, 0.01, args.dcf_c_miss, args.dcf_c_fa
                )
                ...
                scorefile_score.write(
                    "Epoch {}, VEER {:2.4f}, VEER_S1 {:2.4f}, VEER_S2 {:2.4f}, MinDCF05 {:2.5f}, MinDCF01 {:2.5f}\n".format(
                        modelfiles[-i],
                        result[1],
                        result1[1],
                        result2[1],
